...
import 'package:h_electriction/job.dart';
import 'package:h_electriction/jobdetail.dart';
import 'dart:convert';
...
class _TabScreenState extends State<TabScreen> {
                                ...
                                Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                            fit: BoxFit.fill,
                                            image: NetworkImage(
                                                "https://hireelectrian.com/h_electrician(user)/image/${data[index]['jobimage']}.jpg")))),
                                Expanded(
                                  child: Container(
                                    child: Column(
                                      children: <Widget>[
  ...
  Future<String> makeRequest() async {
    String urlLoadJobs = "https://hireelectrian.com/h_electrician(user)/php/load_jobs.php";
