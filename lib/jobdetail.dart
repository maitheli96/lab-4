...
class _DetailInterfaceState extends State<DetailInterface> {
    ...
    return Column(
      children: <Widget>[
        ...
        Container(
          ...
          height: 200,
          child: Image.network(
              'https://hireelectrian.com/h_electrician(user)/image/${widget.job.jobimage}.jpg',
              fit: BoxFit.fill),
        ),
        SizedBox(
          height: 10,
  ...
  Future<String> acceptRequest() async {
    String urlLoadJobs = "https://hireelectrian.com/h_electrician(user)/php/accept_job.php";
