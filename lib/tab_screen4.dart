...
import 'package:h_electriction/mainscreen.dart';
...
//import 'package:h_electriction/splashscreen.dart';
import 'package:h_electriction/user.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:toast/toast.dart';
import 'package:image_picker/image_picker.dart';


String urlgetuser = "https://hireelectrian.com/h_electrician(user)/php/get_user.php";
String urluploadImage =
    "https://hireelectrian.com/h_electrician(user)/php/upload_imageprofile.php";
String urlupdate = "https://hireelectrian.com/h_electrician(user)/php/update_profile.php";
File _image;
int number = 0;
                                    ...
                                    decoration: new BoxDecoration(
                                        ...
                                        image: new DecorationImage(
                                            ...
                                            image: new NetworkImage(
                                                "https://hireelectrian.com/h_electrician(user)/profile/${widget.user.email}.jpg?dummy=${(number)}'")))),
                              ),
                              SizedBox(height: 25),
                              Container(
                                child: Text(
